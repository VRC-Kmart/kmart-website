...
const MainContent = () => {
    return (
        <div className="main-content">
            <h1 style={{ color: 'red', textAlign: 'center' }}>About Kmart</h1>
            <img src={config.building1} style={{ display: 'block', margin: '0 auto' }} alt="Kmart Building" />
            ...
            <button style={{ color: 'red', border: 'none', outline: 'none' }}>The VRC Kmart Story</button>
            <p>The story of a search for nostalgia and community, <br></br>learn how we brought Kmart into the virtual world.</p>
            <button style={{ color: 'red', border: 'none', outline: 'none' }}>VRC Kmart Officers</button>
            <p>See VRC Kmart's officers that help run this group.</p>
            <button style={{ color: 'red', border: 'none', outline: 'none' }}>1996 Kmart Officers</button>
            <p>See Kmart's officers from 1996, the time this website was based from.</p>
            <button style={{ color: 'red', border: 'none', outline: 'none' }}>Kmart Facts</button>
            <p>A year-by-year listing of Kmart's real-life and virtual milestones.</p>
            <button style={{ color: 'red', border: 'none', outline: 'none' }}>Kmart Fun Facts</button>
            <p>Amaze your friends with your awesome knowledge of Kmart!</p>
            <button style={{ color: 'red', border: 'none', outline: 'none' }}>Kmart Financials</button>
            <p>VRC Kmart Corporation's financial performance, history and background info.</p>
            <button style={{ color: 'red', border: 'none', outline: 'none' }}>Kmart History</button>
